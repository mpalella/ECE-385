	nios_system u0 (
		...
		.keyboard_export       (<connected-to-keyboard_export>),       //      keyboard.export
		...
		.otg_hpi_read_export   (<connected-to-otg_hpi_read_export>),   //  otg_hpi_read.export
		.otg_hpi_reset_export  (<connected-to-otg_hpi_reset_export>),  // otg_hpi_reset.export
		.otg_hpi_write_export  (<connected-to-otg_hpi_write_export>),  // otg_hpi_write.export
